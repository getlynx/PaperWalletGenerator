...
janin.currencies = [
    ...
    janin.currency.createCurrency ("Lynx",                0x2d, 0xad, "6",    "S"    , "KAaaYX5rXaSJstmszDEJgxAYjx655CctoE"),
    janin.currency.createCurrency ("Lynx Testnet",        0x6f, 0xef, "9",    "c"    , "ms2Q1NbYsqinfqQKbBCLasg5XFBrbRjbPx")
                   ];
